...
const Footer = () => {
  return (
    <footer className="bg-[#1c1c1e] text-white py-12 mt-1">
      <div className="max-w-screen-xl px-4 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center mt-8 space-x-6">
          ...
          <a
            href="https://www.linkedin.com/in/career-development-center-dbatu-lonere/"
            className="text-white/60 hover:text-white transition-colors duration-200"
          >
          ...
          <a
            href="https://www.instagram.com/cdcdbatu/"
            className="text-white/60 hover:text-white transition-colors duration-200"
          >
        ...
        {/* Copyright */}
        <p className="mt-8 text-base leading-6 text-center text-white/60">
